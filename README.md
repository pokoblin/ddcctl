# ddcctl: DDC monitor controls for the macOS command line

_Read this in another language: [简体中文](README_ZH_CN.md)_

Adjust your external monitors' built-in controls from the macOS shell:
